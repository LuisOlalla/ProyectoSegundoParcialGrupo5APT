document.querySelector('#MD').addEventListener('click', MD);
document.querySelector('#SI').addEventListener('click', SI);
document.querySelector('#DEP').addEventListener('click', DEP);
document.querySelector('#PA').addEventListener('click', PA);
...
document.getElementById('ag').addEventListener('click',guardarSI   )
